  ...
  return (
    <div className="">
      <div className="flex flex-col lg:flex-row items-center justify-between min-h-screen py-8 lg:py-0">
        <div className="w-full lg:w-1/2 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20 order-2 lg:order-1">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4">Lorem ipsum dolor sit amet</h1>
          <p className="mt-4 text-sm sm:text-base md:text-lg leading-relaxed">Lorem ipsum dolor sit amet consectetur. Enim netus cras congue quis elit sociis. Sed mi rhoncus id habitant. In urna tellus nisi platea morbi libero imperdiet neque. Justo suspendisse tristique posuere quis eget viverra. Nunc euismod ultrices etiam nulla habitasse. </p>
          <div className="mt-8 sm:mt-10 md:mt-12">
            <div className="flex flex-col sm:flex-row h-auto sm:h-[47px] items-stretch sm:items-center gap-3 sm:gap-4">
              <input type="text" className="border border-[#C3C3C3] h-[47px] rounded-[6px] flex-1 px-3 min-w-0"/>
              <button type="submit" className="flex-shrink-0">
                <svg className="w-32 sm:w-40 md:w-[168px] h-12 sm:h-16 md:h-[87px]" viewBox="0 0 168 80" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex items-center gap-2 mt-4 ">
              <svg className="w-6 h-6 sm:w-7 sm:h-7 md:w-[30px] md:h-[29px]" viewBox="0 0 30 29" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="relative w-full lg:w-1/2 h-64 sm:h-80 md:h-96 lg:h-screen order-1 lg:order-2">
        <Image 
          src={"bike.svg"} 
          alt={"bike-image"} 
          width={932} 
        ...
        />
        <div className="absolute bottom-0 lg:bottom-36 w-full h-6 bg-[linear-gradient(180deg,rgba(255,255,255,0)_0%,#FFFFFF_100%)]"></div>
        </div>
      ...
      <div className="relative w-full h-[300px] sm:h-[400px] md:h-[607px] overflow-hidden mb-16 sm:mb-20 md:mb-24">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 sm:px-8 md:px-16 z-10">
          <h2 className="text-white text-2xl sm:text-3xl md:text-[42px] lg:text-5xl font-bold mb-4 sm:mb-8 md:mb-8 max-w-xs sm:max-w-xl md:max-w-4xl uppercase tracking-tight my-20" style={{ fontFamily: 'var(--font-roboto-condensed)' }}>
      ...
      <footer className="flex flex-col lg:flex-row px-4 sm:px-6 md:px-10 py-6 md:py-10 justify-between min-h-[400px] lg:h-[546px] bg-[#171E2B] text-white">
        <div className="mb-6 lg:mb-0">
          <svg className="w-24 sm:w-32 md:w-[156px] h-8 sm:h-12 md:h-[60px]" viewBox="0 0 156 60" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 md:gap-12 lg:gap-28 w-full lg:w-auto lg:mr-8 xl:mr-40">
          <div className="flex flex-col">
            <p className="font-bold text-sm sm:text-base mb-3 sm:mb-6">Lorem Ipsum</p>
